...
// once you set the global variables below, rename this file to config.php

define ("ENGINE_NAME","## HAWKSEARCH ENGINE ##");
define ("ENGINE_KEY","## HAWKSEARCH KEY ##");
define ("ENGINE_ENV","## ENVIRONMENT ##");  // dev / test / api
